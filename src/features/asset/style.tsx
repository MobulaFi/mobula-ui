...
export const PopOverLinesStyle =
  "flex items-center relative justify-between min-w-[200px] lg:min-w-[181px] md:min-w-[135px] rounded px-2.5 h-[30px] w-full hover:bg-light-bg-hover hover:dark:bg-dark-bg-hover transition-all duration-200 bg-light-bg-terciary dark:bg-dark-bg-terciary";
