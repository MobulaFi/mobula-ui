        ...
        <Container extraCss="md:w-full mt-0 maximum-width">
          ...
          {isAssetPage ? (
            ...
            <div className="flex flex-col w-full">
              <div className="flex items-center justify-between w-full flex-wrap md:mt-2.5 mb-2.5 lg:mb-0">
                <div className="max-w-[500px] w-fit lg:min-w-[340px] md:max-w-full md:w-full lg:mb-2.5">
                  <TokenMainInfo />
                </div>
                <PairsSocialInfo />
              </div>
